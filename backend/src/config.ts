...
export const CONFIG = {
  ...
  MEMETICS_SIGNER_PRIVATE_KEY:
    process.env.MEMETICS_SIGNER_PRIVATE_KEY ?? process.env.CLAIM_SIGNER_PRIVATE_KEY ?? '',
  MEMETICS_OWNER_PRIVATE_KEY: process.env.MEMETICS_OWNER_PRIVATE_KEY ?? '',
  MEMETICS_CONTRACT_ADDRESS: process.env.MEMETICS_CONTRACT_ADDRESS ?? '',
  ISLAND_IDENTITY_CONTRACT_ADDRESS: process.env.ISLAND_IDENTITY_CONTRACT_ADDRESS ?? '',
  JUNGLE_BAY_ISLAND_CONTRACT_ADDRESS: process.env.JUNGLE_BAY_ISLAND_CONTRACT_ADDRESS ?? '',
  BODEGA_CONTRACT_ADDRESS: process.env.BODEGA_CONTRACT_ADDRESS ?? '',
  COMMISSION_MANAGER_CONTRACT_ADDRESS: process.env.COMMISSION_MANAGER_CONTRACT_ADDRESS ?? '',
  ...
  JBM_TOKEN_ADDRESS: process.env.JBM_TOKEN_ADDRESS ?? '',
